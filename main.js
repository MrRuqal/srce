...
const myAdmin = ['u885396f77de32a72849b6bb13bdeafed','u33e48395655b32cc74775e745211bfd5','u63985fff02d08579b62f33fffe6394cf','u21223b2de309c505df44ad1e2d3fe4f2'];

const myBot = ['u885396f77de32a72849b6bb13bdeafed'];
const banList = [];//Banned list
var vx = {};var midnornama,pesane,kickhim;var waitMsg = "no";//DO NOT CHANGE THIS
var komenTL = "AutoLike by Ruqal\nline://ti/p/~mr.fhrza"; //Comment for timeline
           ...
           if(seq.contentType == 13 && this.sendStaff == 2 && isAdmin(seq.from))
{
    ...
    await this._sendMessage(seq,'Sukses Menghapus Staff~');
       ...
       if(txt == "response name"){
        ...
        if(txt == 'halo') {
          if(isAdmin(seq.from) || isStaff(seq.from)) {
        this._sendMessage(seq, 'Halo Juga Admin Atau Staff ✍T҉̶̘̟̼̉̈́͐͋͌̊Σ̶Δ̶M҉̶̘͈̺̪͓̺ͩ͂̾ͪ̀̋ ̶̶̶̶G̶̶H̶̶O̶̶U̶̶L̶β̶Ω̶T҉̶̘̟̼̉̈́͐͋͌̊✈');
        }
      else
        {
...
let { listMember } = await this.searchGroup(seq.to);
     const mentions = await this.mention(listMember);
       ...
       if(txt == "kickall"){
        ...
        if(txt == 'creator') {
           this._sendMessage(seq, 'My Creator Is fahriza\nId Line : http://line.me/ti/p/~mr.fhrza\n\n-✍T҉̶̘̟̼̉̈́͐͋͌̊Σ̶Δ̶M҉̶̘͈̺̪͓̺ͩ͂̾ͪ̀̋ ̶̶̶̶G̶̶H̶̶O̶̶U̶̶L̶β̶Ω̶T҉̶̘̟̼̉̈́͐͋͌̊✈');
           seq.contentType=13;
       ...
       if(txt == "buka url" || txt == "tutup url" || txt == "spam" || txt == "dadah"){
            if(isAdmin(seq.from))
            {
            }
            else if(isBot(seq.from))
        ...
        const joinByUrl = ['buka url','tutup url'];
